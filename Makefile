...
clean:
	...
	@rm -fr $(BUILD) $(TARGET).pfs0 $(TARGET).nso $(TARGET).nro $(TARGET).nacp $(TARGET).elf \
		MysteryOfSolarusDX.nro MysteryOfSolarusDX.nacp
...
# main targets
#---------------------------------------------------------------------------------
all	:	$(OUTPUT).pfs0 $(OUTPUT).nro launcher
...
launcher: $(OUTPUT).elf
	@nacptool --create "Mystery of Solarus DX" "Solarus Team & carstene1ns" "1.11.0" $(TOPDIR)/MysteryOfSolarusDX.nacp
	@echo built ... MysteryOfSolarusDX.nacp
	@elf2nro $(OUTPUT).elf $(TOPDIR)/MysteryOfSolarusDX.nro --icon=$(TOPDIR)/MysteryOfSolarusDX.jpg --nacp=$(TOPDIR)/MysteryOfSolarusDX.nacp
	@echo built ... MysteryOfSolarusDX.nro
